...
The input file of our analysis was taken from \href{https://wortschatz.uni-leipzig.de/en/download/eng}{Wortschatz Leipzig project}.
...
\begin{itemize}
    ...
    \item $M$: The choice of $M$ determ the fill factor of the hash table, that can be defined as $\alpha=\tfrac{busy\_buckets}{table\_dimension}$. We compute it empirically as $M=10000019$; this choice allow us to have a good fill factor (i.e., 0.75 circa) in order to have a good compromise between memory usage and speed.
\end{itemize}
