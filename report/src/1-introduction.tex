...
\begin{itemize}
    ...
    \item We mantain only one type of separatore between the words, i.e. single space.
\end{itemize}
...
\begin{itemize}
    ...
    \item Each node of the open chain is composed by the string (i.e., the 3-gram) as key and the counter as value.
\end{itemize}